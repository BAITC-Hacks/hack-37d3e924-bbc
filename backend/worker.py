...
def fixture_result(data, progress):
    ...
    example = json.loads((Path(__file__).resolve().parents[1] / 'contracts/examples/result.json').read_text(encoding='utf-8'))
...
class WindowsKillOnCloseJob:
    ...
    def __enter__(self):
        ...
        ok = kernel32.SetInformationJobObject(handle, JobObjectExtendedLimitInformation,
