      ...
      <aside className="sidebar">
        ...
        <div id="meeting-library" className={`meeting-library${libraryOpen ? " is-open" : ""}`}>
          ...
          <footer className="sidebar-note">
            Записи обрабатываются и сохраняются на сервере приложения. Тестовые результаты отмечены отдельно.
          </footer>
        </div>
      </aside>
    ...
    <section className="create-panel">
      ...
      <div className="create-grid">
        <div>
          ...
          <p className="lead">
            Загрузите аудио, дождитесь обработки и проверьте итог перед
            экспортом DOCX.
          </p>
