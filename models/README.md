...
В этом каталоге находятся **все проверенные веса рабочего Mac-профиля**:
...
**Полный MLX-профиль требует macOS Apple Silicon.** Наличие весов в Git
не добавляет MLX на Windows или Linux и не заменяет отдельный CUDA-комплект.
Windows-участники могут использовать исходные ASR/ONNX с подходящими
зависимостями и тестовый интерфейс по корневому README.
